/*
  ...
  1. New Tables
    - `daily_steps`
      ...
      - `employee_id` (varchar, foreign key) - References employees table
      - `device_id` (varchar) - Device identifier for tracking
      ...
      - `streak_tier_achieved` (varchar) - Tier level achieved
...
CREATE TABLE IF NOT EXISTS daily_steps (
  ...
  streak_tier_achieved VARCHAR(50),
